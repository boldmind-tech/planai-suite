...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    icons: [
      { src: '/icons/pwa/icon-72x72.png',          sizes: '72x72',   type: 'image/png', purpose: 'any' },
      { src: '/icons/pwa/icon-72x72-maskable.png',  sizes: '72x72',   type: 'image/png', purpose: 'maskable' },
      { src: '/icons/pwa/icon-96x96.png',           sizes: '96x96',   type: 'image/png', purpose: 'any' },
      { src: '/icons/pwa/icon-96x96-maskable.png',  sizes: '96x96',   type: 'image/png', purpose: 'maskable' },
      { src: '/icons/pwa/icon-128x128.png',         sizes: '128x128', type: 'image/png', purpose: 'any' },
      { src: '/icons/pwa/icon-128x128-maskable.png',sizes: '128x128', type: 'image/png', purpose: 'maskable' },
      { src: '/icons/pwa/icon-144x144.png',         sizes: '144x144', type: 'image/png', purpose: 'any' },
